            ...
            <Grid container lg={12} md={12} justify="center" id="contact">
                ...
                <Grid container justify="center">
                    <Grid item lg={5} md={5} justify="center">
                        ...
                        <Grid container>
                        <Grid item lg={4}>  
                            <MobileStoreButton store="ios" url={iOSUrl} linkProps={{title: "iOS Store Button"}} className={classes.mac}/>
                        </Grid>
                        <Grid item lg={4}>  
                            <MobileStoreButton store="android" url={androidUrl} linkProps={{title: "Android Store Button"}} className={classes.google}/>
                        </Grid>
                        </Grid>
                    </Grid>
                    <Grid lg={1}/>
                    ...
                    <Typography variant="h6" className={classes.mailus} style={{textAlign: 'center', marginBottom:'2vh'}} >
                    ...
                    <div className={classes.margin}>
                        <Grid container spacing={1} alignItems="flex-end">
                            ...
                            <TextField id="outlined-basic" label="Your Message" variant="outlined" style={{margin:'4vh 0', width:'30rem'}} className={classes.body} />
                    </div>
                    </Paper>
                    </Grid>
                </Grid>          
